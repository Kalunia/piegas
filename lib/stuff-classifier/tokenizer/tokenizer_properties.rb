...
StuffClassifier::Tokenizer::TOKENIZER_PROPERTIES = {
  ...
  "pt" => {
    :stop_word => Set.new([
    'de', 'a', 'o', 'que', 'e', 'do', 'da', 'em', 'um', 'para', 'é', 'eh', 'com',
    'não', 'nao', 'naum', 'uma', 'os', 'no', 'se', 'na', 'por', 'mais', 'as', 'dos',
    'como', 'mas', 'foi', 'ao', 'ele', 'das', 'tem', 'à', 'seu', 'sua', 'ou', 'ser', 'quando', 'muito',
    'há', 'nos', 'já', 'está', 'eu', 'também', 'tambem', 'tmb', 'só', 'soh',
    'pelo', 'pela', 'até', 'ateh', 'isso', 'ela', 'entre', 'era', 'depois', 'sem', 'mesmo', 'aos', 'ter', 'seus',
    'quem', 'nas', 'me', 'esse', 'eles', 'estão', 'você', 'voce', 'vc', 'tinha', 'foram', 'essa', 'num',
    'nem', 'suas', 'meu', 'às', 'minha', 'têm', 'numa', 'pelos', 'elas', 'havia', 'seja', 'qual', 'será',
    'nós', 'nois', 'tenho', 'lhe', 'deles', 'essas', 'esses', 'pelas', 'este', 'fosse', 'dele'
    ])
  }
}