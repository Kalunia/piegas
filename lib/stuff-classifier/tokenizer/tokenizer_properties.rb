...
StuffClassifier::Tokenizer::TOKENIZER_PROPERTIES = {
  "pt" => {
    :stop_word => Set.new([
     ...
     's', 'sao', 'são', 'se', 'seja', 'sem', 'ser', 'será', 'seu', 'seus', 'só', 'sobre', 'soh', 'somente', 'sua', 'suas', 
     't', 'ta', 'tambem', 'também', 'tão', 'tem', 'têm', 'tempo', 'tenho', 'tentar', 'ter', 'tinha', 'tmb', 'to', 'tou', 'todo', 'todos', 'tu',
     'u', 'último', 'ultimo', 'um', 'uma', 'uns', 'usa', 'usar',
     'x',
     'v', 'vai', 'vem', 'ver', 'veja', 'verdade', 'verdadeiro', 'vc', 'vcs', 'voce', 'você', 'vs'          
    ]),
